    ...
    <footer className="bg-[#0A1F44] text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm mt-4">
              Advancing blockchain research, innovation, and policy development
              across Africa.
            </p>
            <div className="flex gap-3 mt-4">
              ...
              <div className="flex gap-3 mt-4">
                {/* Twitter */}
                <a
                  href="https://x.com/Spentdigilabs?t=xxU3WrO2LQCh8T3kb3Zbmg&s=08"
                  target="_blank"
                ...
                {/* LinkedIn */}
                <a
                  href="https://www.linkedin.com/company/spent-digital-labs/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-white hover:bg-[#00BFA6] rounded-lg flex items-center justify-center transition"
                  aria-label="LinkedIn"
                ...
                >
                  <FontAwesomeIcon
                    icon={faGithub}
                    className="size-7 text-black hover:text-black"
                  />
                </a>

                {/* YouTube */}
                <a
                  href="https://youtube.com/@spentdigitallabs?si=xQpl-QCqbBk3um7A"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-white hover:bg-[#00BFA6] rounded-lg flex items-center justify-center transition"
                  aria-label="YouTube"
              ...
              <ul className="space-y-2">
                {links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-gray-300 hover:text-[#00BFA6] text-sm transition"
                    >
                      {link.name}
                    </Link>
                  </li>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-gray-300">
          ...
          <div>
            ...
            <a
              href="mailto:info@blockchainresearch.africa"
              className="hover:text-[#00BFA6] hover:underline transition ease-in-out"
            >
              info@blockchainresearch.africa
            </a>
            <br />
            <a
              href="mailto:research@blockchainresearch.africa"
              className="hover:text-[#00BFA6] hover:underline transition ease-in-out"
            >
          ...
          <div>
            ...
            <Link href="https://wa.me/2348142273966" className="flex gap-2">
              <span>WhatsApp:</span>
              <span className="hover:underline hover:text-[#00BFA6] transition ease-in-out">
                +234 814 227 3966
              </span>
            </Link>{" "}
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-300 gap-4">
          <div>
            © {currentYear} Blockchain Research Institute Africa. All rights
            reserved.
          </div>
          <div className="flex gap-6">
            <Link href="/privacy-policy" className="hover:text-[#00BFA6]">
              Privacy Policy
            </Link>
            <Link href="/terms-of-service" className="hover:text-[#00BFA6]">
              Terms of Service
            </Link>
            <Link href="/cookie-policy" className="hover:text-[#00BFA6]">
              Cookie Policy
            </Link>
          </div>
        </div>
