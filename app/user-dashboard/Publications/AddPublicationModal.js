                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4">
                        ...
                        <button
                            type="submit"
                            disabled={isSubmitting}
                            className={`w-full sm:w-auto px-6 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-400 transition font-medium ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''
                                }`}
                        >
