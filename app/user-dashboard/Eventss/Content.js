      ...
      <div className='grid grid-cols-1 gap-6'>
        <div className="md:flex justify-between items-center space-y-3">
          ...
          <button 
            ...
            className="bg-teal-600 cursor-pointer hover:bg-teal-400 text-white px-4 py-2 rounded-lg text-sm"
          >
            + Add Event
          </button>
        </div>
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex gap-2">
                <button 
                  ...
                  className="px-3 py-1 bg-teal-100 hover:bg-teal-200  rounded text-sm"
                >
                  ←
                </button>
                <button 
                  ...
                  className="px-3 py-1 bg-teal-500 hover:bg-teal-200 rounded text-sm"
                >
                  Today
                </button>
                <button 
                ...
                return (
                  <div 
                    ...
                    className={`
                      ...
                      ${isToday ? 'bg-teal-500 text-black hover:bg-teal-200' : ''}
                      ${dayObj.day === selectedDate && dayObj.isCurrentMonth && !isToday ? 'bg-teal-500' : ''}
                    `}
                  >
                    {dayObj.day}
                    {hasEvents && (
                      <div className="absolute bottom-0.5 w-1 h-1 bg-teal-600 rounded-full"></div>
                    )}
                  </div>
                )
              })}
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <div className="gap-2 flex flex-wrap mt-1">
                            {isEventToday(event) && (
                              <span className="bg-teal-600 text-teal-700 text-xs px-2 py-0.5 rounded-full">
                                Today
                              </span>
                            )}
                            {isEventPast(event) && (
                            ...
                            {event.tags.map((tag, index) => (
                              <span key={index} className="bg-teal-600 text-teal-700 text-xs px-2 py-0.5 rounded-full">
                                {tag}
                              </span>
                            ))}
                          </div>
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <div className='gap-2 flex flex-wrap mt-1'>
                            ...
                            {event.tags.map((tag, index) => (
                              <span key={index} className="bg-teal-200 text-teal-700 text-xs px-2 py-0.5 rounded-full">
                                {tag}
                              </span>
                            ))}
                          </div>
